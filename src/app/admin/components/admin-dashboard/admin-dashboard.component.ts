...
export class AdminDashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.subscriptionTranslate = this.translateService.onLangChange.subscribe(() => this.reloadData());
  }

  reloadData(): void {
    this.lineChartDataPublications = [{ data: [], label: '' }];
    this.lineChartDataUsers = [{ data: [], label: '' }];
    this.lineChartDataConsults = [{ data: [], label: '' }];
